<template>
  <div class="bg-[#131313] h-18 flex items-center">
    ...
    <div class="flex flex-row justify-end items-end ml-auto mr-20">
      <div @click="showSignup = true"
      class="cursor-pointer text-white text-sm font-semibold flex flex-row pr-4">
      ...
      <div @click="showSignup = true"
      class="cursor-pointer text-white pl-3"
      >  
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
