<template>
    ...
    <div class="relative w-full h-full max-w-md md:h-auto">
        ...
        <div class="relative bg-white rounded-2xl shadow dark:bg-gray-700">
            <button type="button"
                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-800 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                data-modal-toggle="auth-modal">
                <fa-icon class="w-5 h-5" size="lg"></fa-icon>
                <span class="sr-only">Close modal</span>
            </button>
            <!-- Modal header -->
            <div class="px-6 py-4 border-b rounded-t dark:border-gray-600">
                <h3 class="text-base font-semibold text-gray-800 lg:text-xl dark:text-white">
                    Connect wallet
                </h3>
            </div>
            <!-- Modal body -->
            <div class="p-6">
                ...
                <ul class="my-4 space-y-3">
                    <!-- Metamask -->
                    <li>
                        <a (click)="connectWallet()" data-modal-toggle="auth-modal"
                            class="flex items-center p-3 text-base font-bold text-gray-800 rounded-xl cursor-pointer hover:bg-gray-100 group dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <!-- Coinbase Wallet -->
                    <li>
                        <a href="#" data-modal-toggle="auth-modal"
                            class="flex items-center p-3 text-base font-bold text-gray-800 rounded-xl hover:bg-gray-100 group dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                ...
                <div>
                    <a href="#" data-modal-toggle="auth-modal"
                        ...
                        <svg aria-hidden="true" class="w-3 h-3 mr-2" focusable="false"
